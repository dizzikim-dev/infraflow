...
const CLOUD_FAILURES: FailureScenario[] = [
  {
    id: 'FAIL-CLD-001',
    type: 'failure',
    component: 'aws-vpc',
...
const K8S_FAILURES: FailureScenario[] = [
  {
    id: 'FAIL-K8S-001',
    type: 'failure',
    component: 'kubernetes',
...
// ---------------------------------------------------------------------------
// Auth/SASE Failures (FAIL-AUTH-004 ~ FAIL-AUTH-007)
// ---------------------------------------------------------------------------

const AUTH_EXT_FAILURES: FailureScenario[] = [
  {
    id: 'FAIL-AUTH-004',
    type: 'failure',
    component: 'sso',
...
// ---------------------------------------------------------------------------
// Hybrid/Multi-Cloud Failures (FAIL-HYB-001 ~ FAIL-HYB-004)
// ---------------------------------------------------------------------------

const HYBRID_FAILURES: FailureScenario[] = [
  {
    id: 'FAIL-HYB-001',
    type: 'failure',
    component: 'vpn-gateway',
...
const SASE_FAILURES: FailureScenario[] = [
  {
    id: 'FAIL-SASE-001',
    type: 'failure',
