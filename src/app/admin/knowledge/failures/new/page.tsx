...
const config: FormConfig = {
  ...
  fields: [
    { key: 'failureId', label: 'Failure ID', type: 'text', required: true, placeholder: 'FAIL-XXX-001' },
    { key: 'component', label: 'Component', type: 'text', required: true, placeholder: 'firewall' },
    { key: 'titleKo', label: '제목 (한국어)', type: 'text', required: true, placeholder: '방화벽 규칙 오류' },
    { key: 'scenarioKo', label: '시나리오 (한국어)', type: 'textarea', rows: 4, placeholder: '장애 시나리오 설명...' },
    { key: 'impact', label: '영향도', type: 'select', defaultValue: 'degraded', options: [
    ...
    { key: 'likelihood', label: '발생 가능성', type: 'select', defaultValue: 'medium', options: [
      { value: 'high', label: 'high (높음)' },
      { value: 'medium', label: 'medium (중간)' },
      { value: 'low', label: 'low (낮음)' },
    ]},
    { key: 'affectedComponents', label: '영향받는 컴포넌트', type: 'array', defaultValue: [] },
    { key: 'preventionKo', label: '예방책 (한국어)', type: 'array', defaultValue: [] },
    { key: 'mitigationKo', label: '완화 방안 (한국어)', type: 'array', defaultValue: [] },
    { key: 'estimatedMTTR', label: 'Estimated MTTR', type: 'text', placeholder: '30m' },
